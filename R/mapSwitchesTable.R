...
#' Return the vocab mapping switch table
#'
#'
...
createMapSwitchesTable <- function(connectionDetails,
                              oldVocab,
                              newVocab,
                              targetDatabaseSchema,
                              mapSwitchesTable){

  sqlFile = "vocabMapSwitches.sql"
  ...
  writeLines("Return maping switch vocab table")
  #SqlRender::writeSql(sql,"domainChangeTest.sql")
